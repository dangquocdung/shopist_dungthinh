    ...
    <div class="col-md-12">
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
          @if(isset($settings_data['general_settings']['recaptcha_options']['enable_recaptcha_for_vendor_login']) && $settings_data['general_settings']['recaptcha_options']['enable_recaptcha_for_vendor_login'] == true)
            <input type="checkbox" checked="checked" class="shopist-iCheck" name="inputEnableForVendor" id="inputEnableForVendor">            
          @else
            <input type="checkbox" class="shopist-iCheck" name="inputEnableForVendor" id="inputEnableForVendor">        
          @endif
          &nbsp; {{ trans('admin.recaptcha_for_vendor_label') }}
          </div>
        </div>
        <div class="form-group">
