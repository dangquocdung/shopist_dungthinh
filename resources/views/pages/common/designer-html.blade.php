    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="overflow:auto;">
      <div class="canvas-container-main">
        ...
        <div id="swap-popover-content" class="hide">
          ...
          <div data-id="{{ $row->id }}" data-design_img_url="{{ get_image_url($row->design_img_url) }}" data-design_trans_img_url="{{ get_image_url($row->design_trans_img_url) }}" class="design-title-items"><div><img src="{{ get_image_url($row->design_title_icon) }}"></div><div class="design-title-label">{!! $row->title_label !!}</div></div>
          @endforeach
        </div>
