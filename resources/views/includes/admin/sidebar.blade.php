<aside class="main-sidebar">
  ...
  <!--            @if(in_array('vendors_refund_request_access', $user_permission_list)) 
              @if(Request::is('admin/vendors/refund'))  
              <li class="active"><a href="{{ route('admin.refund_content') }}"><i class="fa fa-exchange"></i> {!! trans('admin.sidebar_refund_title') !!}</a></li>
              @else
              <li><a href="{{ route('admin.refund_content') }}"><i class="fa fa-exchange"></i> {!! trans('admin.sidebar_refund_title') !!}</a></li>
              @endif
            @endif-->
